    ...
    <section class="checkout-wrapper section">
        <div class="container">
            <div class="row justify-content-center">
               <div class="col-12">
                   <h4 class="text-center">You have to login start your checkout process. If you are not register then please register first</h4>
               </div>
                                ...
                                <form class="card login-form" action="{{route('customer.store')}}" method="post">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input class="form-control" name="name" type="name" id="reg-name" required>
                                        </div>
                                        <div class="form-group input-group">
                                            <label for="reg-email">Email</label>
                                            <input class="form-control" name="email" type="email" id="reg-email" required>
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input class="form-control" name="mobile" type="mobile" id="reg-mobile" required>
                                        </div>
                                        <div class="button">
