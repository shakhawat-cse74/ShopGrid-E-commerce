                                ...
                                <div class="shopping-item">
                                    ...
                                    <ul class="shopping-list">
                                        @foreach(Cart::content() as $item)
                                            <li>
                                                <a href="{{route('cart.remove',['rowId' => $item->rowId])}}" class="remove" title="Remove this item"><i class="lni lni-close"></i></a>
                                                ...
                                                <div class="content">
                                                    <h4><a href="">
                                                            {{$item->name}}</a></h4>
                                                    <p class="quantity">{{$item->qty}} x {{$item->price}} =  <span class="amount">{{$item->qty * $item->price}}</span></p>
                                                </div>
                                            </li>
                                        @endforeach
                                    </ul>
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount">TK.</span>
                                        </div>
                                        <div class="button">
