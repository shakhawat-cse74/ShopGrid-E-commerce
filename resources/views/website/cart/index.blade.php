...
@section('body')
    ...
    <div class="shopping-cart section">
        <div class="container">
            <h4 class="text-center text-success pb-3">{{session('message')}}</h4>
            <div class="cart-list-head">
                ...
                @foreach($cart_products as $cart_product)
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-1 col-md-2 col-12">
                            <a class="remove-item" href="{{route('cart.remove',['rowId' => $cart_product->rowId])}}"><i class="lni lni-close"></i></a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    <ul>
                                        ...
                                        <li>Tax Amount<span>TK. {{round(($tax = $sum*0.15))}}</span></li>
