                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('unit.store')}}" method="POST" >
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="name" id="firstName" placeholder="Category Name" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="lastName" class="col-md-3 form-label">Unit Description</label>
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" id="lastName" placeholder="Category Description"></textarea>
                            </div>
                        </div>
